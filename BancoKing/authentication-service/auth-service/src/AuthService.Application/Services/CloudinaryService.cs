...
public class CloudinaryService(IConfiguration configuration) : ICloudinaryService
{
    ...
    {
        var defaultPath = configuration["CloudinarySettings:DefaultAvatarPath"] ?? "default_avatar_wngf8f.png";
    ...
    {
        var baseUrl = configuration["CloudinarySettings:BaseUrl"] ?? "https://res.cloudinary.com/djf4kg5jq/image/upload/v1771084649";
        var folder = configuration["CloudinarySettings:Folder"] ?? "auth_bk_system/profiles";
        var defaultPath = configuration["CloudinarySettings:DefaultAvatarPath"] ?? "default_avatar_wngf8f.png";
